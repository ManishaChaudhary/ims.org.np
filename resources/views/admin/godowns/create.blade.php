                            ...
                            {{ Form::open(['url' => route('admin.godowns.store') , 'method' => 'Post','enctype'=> 'multipart/form-data']) }}
                                <div class="card-body">
                                    <div class="form-group">
                                        {{Form::label('Name')}}
                                        {{Form::text('title' , null , ['class' => 'form-control form-control-user' ,'placeholder'=>'ABC Godown' ,'required' => 'required'])}}
                                    </div>
                                    <div class="form-group">
                                        {{Form::label('Godown Code')}}
                                        {{Form::text('code' , null , ['class' => 'form-control form-control-user','placeholder'=>'ABC234' , 'required' => 'required'])}}
                                    </div>
                                    <div class="form-group">
                                        {{Form::label('Company')}}

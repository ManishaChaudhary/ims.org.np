                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Challan Out</h3>
                            </div>
                            {{ Form::open(['url' => route('admin.challan-out.store'), 'method' => 'POST','enctype'=> 'multipart/form-data']) }}
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        {{Form::label('Out Date')}}
                                        {{Form::date('out_date' ,null , ['class' => 'form-control form-control-user' ,'placeholder'=>'Entry Date' ,'required' => 'required'])}}
                                    </div>
                                    <div class="form-group">

                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Challan In</h3>
                            </div>
                            {{ Form::open(['url' => route('admin.challans.store'), 'method' => 'POST','enctype'=> 'multipart/form-data']) }}
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    {{Form::label('Company')}}
                                    <select name="company_id" id="company_id" class="form-control company select2"
                                            required="required"
